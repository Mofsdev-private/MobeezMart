...
namespace MobeezMartWeb.Areas.Customer.Controllers
{
    [Area("Customer")]
    [Authorize]
    public class CartController : Controller
    {
		...
		public IActionResult orderConfirmation(int id)
		{
			...
			_emailSender.SendEmailAsync(orderHeader.ApplicationUser.Email, "New Order - Mobeez Mart", "<p>New Order Created</p>");
		...
		private double GetPriceBasedOnQuantity( double quantity, double listPrice, double price50, double price100)
        {
            if(quantity <= 50)
            {
                return listPrice;
